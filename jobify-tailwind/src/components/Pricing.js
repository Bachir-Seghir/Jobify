...
const tiers = [
  {
    ...
    priceMonthly: 29,
    description:
      "Post a job on Jobify for visibility among your connections and in search results. You can have only 3 job posts open at a time.",
    features: [
      "Your job post appears in search results and is searchable on Jobify",
  ...
  },
  {
    ...
    priceMonthly: 49,
    description:
      "Get 3x more qualified applicants through a more targeted and broader reach to the most relevant candidates on Jobify. ",
    features: [
      "Your job post appears in search results and is searchable on Jobify",
      "Easily filter and manage your applicants.",
      "Your job post is eligible to appear at the top of search results with a “Featured” tag when job seekers search for jobs like yours.",
